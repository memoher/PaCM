(function () {
    ...
    PaCM.controllers.controller('assemblyCtrl', function ($scope, $state, $stateParams, $ionicHistory, $ionicTabsDelegate, userSession, dbRepository, dbSynchronizer, searcherModal, notesModal) {
